...
namespace Xing.OAuth
{
    /// <summary>
    /// Provides LinkedIn client authorization using the OAuth authorization protocol.
    /// </summary>
    [Serializable]
    public abstract class OAuthAuthorization : IAuthorization, IDisposable
    {
        /// <summary>
        ...
        protected static readonly ServiceProviderDescription LinkedInServiceDescription = new ServiceProviderDescription
        {
            RequestTokenEndpoint = new MessageReceivingEndpoint(
              string.Format(CultureInfo.InvariantCulture, "{0}{1}", Constants.ApiBaseUrl, Constants.RequestTokenResourceName),
              HttpDeliveryMethods.AuthorizationHeaderRequest | HttpDeliveryMethods.GetRequest),
            UserAuthorizationEndpoint = new MessageReceivingEndpoint(
              string.Format(CultureInfo.InvariantCulture, "{0}{1}", Constants.ApiBaseUrl, Constants.AuthorizeTokenMethod),
              HttpDeliveryMethods.AuthorizationHeaderRequest | HttpDeliveryMethods.GetRequest),
            AccessTokenEndpoint = new MessageReceivingEndpoint(
              string.Format(CultureInfo.InvariantCulture, "{0}{1}", Constants.ApiBaseUrl, Constants.AccessTokenResourceName),
              HttpDeliveryMethods.AuthorizationHeaderRequest | HttpDeliveryMethods.GetRequest),
